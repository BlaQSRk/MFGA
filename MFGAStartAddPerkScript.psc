...
Actor Player
Perk [] MFGAPerkArray
;Perk Property MFGAPerkTokenMolerat Auto Const Deprecated
...
Function ReInit()
	...
	MFGAPerkArray [1] = MFGA_SkillPerkReloadAutoRifle ;AV: MFGA_ARifleReloadAV
	MFGAPerkArray [2] = MFGA_SkillPerkReloadHeavy ;AV: MFGA_HeavyReloadAV
	MFGAPerkArray [3] = MFGA_SkillPerkReloadMissile ;AV: MFGA_MissileReloadAV
	MFGAPerkArray [4] = MFGA_SkillPerkReloadPistol 
	MFGAPerkArray [5] = MFGA_SkillPerkReloadShotgun
	MFGAPerkArray [6] = MFGA_SkillPerkReloadSniperRifle
	MFGAPerkArray [7] = MFGA_SkillPerkReloadRifle
	MFGAPerkArray [8] = MFGASkillPerkAccAutoRifle
	MFGAPerkArray [9] = MFGASkillPerkAccHeavy
	MFGAPerkArray [10] = MFGASkillPerkAccMissile
	MFGAPerkArray [11] = MFGASkillPerkAccPistol
	MFGAPerkArray [12] = MFGASkillPerkAccPistol ;MFGASkillPerkAccShotgun
	MFGAPerkArray [13] = MFGASkillPerkAccSniperRifle
	MFGAPerkArray [14] = MFGASkillPerkAccRifle
	MFGAPerkArray [15] = MFGASkillPerkDmgAutoRifle
	MFGAPerkArray [16] = MFGASkillPerkDmgHeavy
	MFGAPerkArray [17] = MFGASkillPerkDmgMissile
	MFGAPerkArray [18] = MFGASkillPerkDmgPistol
	MFGAPerkArray [19] = MFGASkillPerkDmgShotgun
	MFGAPerkArray [20] = MFGASkillPerkDmgSniperRifle
	MFGAPerkArray [21] = MFGASkillPerkDmgRifle/;
